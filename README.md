...
When you press a different tab, the container `scrollWindow` will be scrolled to the top. This only works if you add overflow to `tabs-component-panels`. 
```
...
### No scrolling on tab change
The id's of the tabs have a prefix `tab-`. The hash in the URL bar would normally scroll your window to this id, however since the id doesn't match, your window wont scroll.
